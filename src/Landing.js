...
const FAQ_ITEMS = [
  ...
  {q:"What happens when my Free plan session limit is reached?", a:"You can run up to 5 active sessions on the Free plan. You'll be prompted to upgrade to Pro for unlimited sessions."},
