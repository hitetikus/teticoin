...
const TIP_ICONS = {
  ...
  "Participation Base Pay": ({s=36})=><svg width={s} height={s} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path style="fill:#78D2FA;" d="M217.21,353.387c-7.692-7.987-17.642-13.886-29.026-16.614l-41.143-9.859l-0.017,0.027l0.017-0.027
    ...
    <div className="tc-app-shell" style={{minHeight:"100vh",background:BG,fontFamily:"Poppins,sans-serif",display:"flex",flexDirection:"column"}}>
      ...
      <div className="tc-home-wrap" style={{flex:1,overflowY:"auto",display:"flex",flexDirection:"column"}}>
        ...
        <div className="tc-home-topnav" style={{display:"none",background:"#fff",borderBottom:`1px solid ${BORDER}`,padding:"0 32px",height:64,alignItems:"center",justifyContent:"space-between",flexShrink:0}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:10}}>
          <button onClick={()=>setShowTips(true)} title="Host Tips" className="tp-bulb-btn" style={{width:38,height:38,border:"none",background:"none",display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",flexShrink:0,padding:0}}><iframe src="https://lottie.host/embed/60e7e27d-62da-4cea-8848-9f70d5ed4b66/3kpRZ5w0ze.lottie" style={{width:44,height:44,border:"none",pointerEvents:"none"}} title="bulb"/></button>
        ...
        <div className="tc-home-inner">
          ...
          <div className="tc-home-left" style={{padding:"20px"}}>
            ...
            <div className="tc-home-mobile-topbar" style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:20}}>
              ...
              <div style={{display:"flex",alignItems:"center",gap:8}}>
              <button onClick={()=>setShowTips(true)} title="Host Tips" className="tp-bulb-btn" style={{width:36,height:36,border:"none",background:"none",display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",flexShrink:0,padding:0}}><iframe src="https://lottie.host/embed/60e7e27d-62da-4cea-8848-9f70d5ed4b66/3kpRZ5w0ze.lottie" style={{width:40,height:40,border:"none",pointerEvents:"none"}} title="bulb"/></button>
              <button onClick={()=>setProfileOpen(v=>!v)}
