...
function MassGive({ participants, groups, onAward, onClose }) {
  ...
  function cleanScannerDom() {
    try { const el = document.getElementById("tc-qr-scanner"); if (el) el.innerHTML = ""; } catch(e) {}
  }
    ...
    function initScanner() {
      ...
      try {
        ...
        scanner.start(
          ...
          html5QrRef.current = null;
          cleanScannerDom();
          setScannerErr("Camera access denied. Tap Back and allow camera access in your browser settings.");
          setScanning(false);
        });
      } catch(e) {
        cleanScannerDom();
        setScannerErr("Could not start camera. Tap Back and try again.");
        setScanning(false);
      }
    }
              ...
              <div onClick={e=>e.stopPropagation()}>
                ...
                {ok && !scanning && scannerErr && (
                  <div style={{background:"#FEF2F2",border:"1px solid #FCA5A5",borderRadius:12,padding:"14px 16px",marginBottom:10,display:"flex",flexDirection:"column",gap:10}}>
                    ...
                    <button onClick={()=>{ setScannerErr(""); setScanning(false); setMode(null); cleanScannerDom(); }}
                      style={{width:"100%",padding:"9px 0",background:"none",border:`1.5px solid #FCA5A5`,borderRadius:10,fontFamily:"Plus Jakarta Sans,sans-serif",fontWeight:700,fontSize:13,color:"#EF4444",cursor:"pointer"}}>
                      Back
                    </button>
                  </div>
                )}
          ...
          {joinScanErr && (
            <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:32,gap:16}}>
              ...
              <div style={{textAlign:"center",color:"#fff",fontFamily:"Plus Jakarta Sans,sans-serif"}}>
                ...
                <div style={{fontSize:13,color:"rgba(255,255,255,.6)"}}>Check your browser settings to allow camera access, then try again.</div>
              </div>
            </div>
          )}
          <div style={{position:"absolute",bottom:0,left:0,right:0,background:"rgba(0,0,0,.75)",backdropFilter:"blur(10px)",padding:"16px 20px 32px",display:"flex",flexDirection:"column",gap:10}}>
