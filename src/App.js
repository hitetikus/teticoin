...
const TIP_ICONS = {
  "Early Bird Entry": ({c,bg,s=36})=><svg width={s} height={s} viewBox="0 0 511.909 511.909" xmlns="http://www.w3.org/2000/svg"><path d="m342.334 57.461-295.325 295.336c-8.757 8.757-2.555 23.73 9.829 23.73l222.567.003c104.532.001 189.273-84.738 189.273-189.27v-77.467c0-40.875-33.135-74.01-74.01-74.01-19.629 0-38.454 7.798-52.334 21.678z" fill={bg}/><path d="m10 457.947c24.742 24.44 64.574 24.318 89.165-.274l200.756-200.756-44.446-44.446z" fill={c} fillOpacity=".6"/><path d="m23.34 376.459c79.764 45.496 180.324 31.798 245.255-33.133 58.576-58.576 58.796-153.766.221-212.342z" fill={c} fillOpacity=".35"/><circle cx="407" cy="118" r="10" fill={c}/><circle cx="437" cy="285" r="7" fill={c} fillOpacity=".5"/></svg>,
  "Post-Break Check-In": ({c,bg,s=36})=><svg width={s} height={s} viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="20" width="44" height="32" rx="2" fill={bg}/><rect x="4" y="20" width="44" height="8" fill={c} fillOpacity=".3"/><rect x="16" y="50" width="20" height="4" fill={c} fillOpacity=".4"/><path d="m4 54h44v2a4 4 0 0 1-4 4h-36a4 4 0 0 1-4-4z" fill={c} fillOpacity=".5"/><line x1="20" y1="4" x2="20" y2="17" stroke={c} strokeWidth="2.5" strokeLinecap="round"/><line x1="26" y1="4" x2="26" y2="17" stroke={c} strokeWidth="2.5" strokeLinecap="round"/><line x1="32" y1="4" x2="32" y2="17" stroke={c} strokeWidth="2.5" strokeLinecap="round"/><line x1="38" y1="4" x2="38" y2="17" stroke={c} strokeWidth="2.5" strokeLinecap="round"/><path d="m50 22h6a4 4 0 0 1 4 4v9a4 4 0 0 1-3 3.9l-7 1.4" stroke={c} strokeWidth="1.5" fill="none" strokeLinecap="round"/></svg>,
  "Exit Ticket": ({c,bg,s=36})=><svg width={s} height={s} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><rect x="98" y="45" width="270" height="394" rx="4" fill={bg}/><path d="m117.24 64.139-70.554-36.26c-1.921-.987-4.05-1.502-6.21-1.502h-23.494c-5.359 0-9.704 4.345-9.704 9.704v439.839c0 5.359 4.345 9.704 9.704 9.704h22.863l70.395-44.166z" fill={c} fillOpacity=".2"/><path d="m503.059 304.045-75.233-75.233c-3.591-3.591-9.732-1.048-9.732 4.031v42.407h-175.808v52.066c0 2.68 2.172 4.852 4.852 4.852h170.956v42.407c0 5.079 6.14 7.622 9.732 4.031l75.233-75.233c2.226-2.226 2.226-5.836 0-8.062z" fill={c} fillOpacity=".7"/><line x1="150" y1="155" x2="270" y2="155" stroke={c} strokeWidth="14" strokeLinecap="round"/><line x1="150" y1="188" x2="270" y2="188" stroke={c} strokeWidth="14" strokeLinecap="round"/><line x1="150" y1="221" x2="215" y2="221" stroke={c} strokeWidth="14" strokeLinecap="round"/></svg>,
  "Group Debate Scoring": ({c,bg,s=36})=><svg width={s} height={s} viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><rect x="2" y="6" width="26" height="15" rx="2" fill={bg}/><path d="m8 21v5l7-5h2" stroke={c} strokeWidth="1.5" strokeLinejoin="round" fill="none"/><rect x="36" y="6" width="26" height="15" rx="2" fill={c} fillOpacity=".25"/><path d="m56 21v5l-7-5h-2" stroke={c} strokeWidth="1.5" strokeLinejoin="round" fill="none"/><line x1="32" y1="2" x2="32" y2="62" stroke="#D1D5DB" strokeWidth="1" strokeDasharray="3 2"/><path d="m26 46 l6-9 l6 9" stroke="#F59E0B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="#F59E0B" fillOpacity=".25"/></svg>,
  "Group Speed Race": ({c,bg,s=36})=><svg width={s} height={s} viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"><path d="m8 44h44" stroke={c} strokeWidth="2" strokeLinecap="round"/><path d="m12 44v-14q0-8 8-8h20q8 0 8 14" fill={c} fillOpacity=".18" stroke={c} strokeWidth="1.5"/><circle cx="17" cy="46" r="4" fill={c} fillOpacity=".5" stroke={c} strokeWidth="1"/><circle cx="43" cy="46" r="4" fill={c} fillOpacity=".5" stroke={c} strokeWidth="1"/><path d="m47 14 l8 4-8 4" stroke="#F59E0B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><line x1="30" x2="55" y1="18" y2="18" stroke="#F59E0B" strokeWidth="1.5" strokeLinecap="round" strokeDasharray="2 2"/></svg>,
  "Consolation Coins": ({c,bg,s=36})=><svg width={s} height={s} viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><rect x="15" y="21" width="36" height="28" rx="2" fill={bg}/><rect x="12" y="18" width="40" height="6" rx="1" fill={c} fillOpacity=".4"/><rect x="30" y="21" width="6" height="28" fill={c} fillOpacity=".4"/><ellipse cx="42" cy="9" rx="8" ry="5" fill={c} fillOpacity=".4" transform="rotate(-45 42 9)"/><ellipse cx="22" cy="9" rx="5" ry="8" fill={c} fillOpacity=".25" transform="rotate(-45 22 9)"/><path d="m9 49v12l12-.03 26.5-8.6 10.8-12.7c.5-.6.3-1.4-.1-1.9a5.7 5.7 0 0 0-7.8.6l-7.4 8.1h-13.5a4 4 0 0 0-4 4h-14l-3 5" fill={c} fillOpacity=".3"/></svg>,
  "Welcome Bonus": ({c,bg,s=36})=><svg width={s} height={s} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><rect x="7.5" y="342" width="497" height="143" rx="15" fill={bg}/><rect x="121" y="27" width="270" height="315" fill={c} fillOpacity=".12"/><rect x="226" y="57" width="60" height="37" rx="5" fill={c} fillOpacity=".6"/><rect x="226" y="94" width="60" height="210" fill={c} fillOpacity=".25"/><path d="m173.5 68-22.5-11v285l22.5-11zm165 0 22.5-11v285l-22.5-11z" fill={c} fillOpacity=".4"/><rect x="121" y="320" width="30" height="22" fill={c} fillOpacity=".35"/><rect x="361" y="320" width="30" height="22" fill={c} fillOpacity=".35"/></svg>,
  "Energy Reset": ({c,bg,s=36})=><svg width={s} height={s} viewBox="0 0 512.719 512.719" xmlns="http://www.w3.org/2000/svg"><circle cx="256" cy="256" r="192" fill={bg}/><path d="m312.423 108.12h-78.74c-2.587 0-4.883 1.657-5.699 4.112l-44.329 133.443c-1.291 3.887 1.603 7.898 5.699 7.898h43.342l-28.98 144.253c-.806 6.404 7.678 9.396 11.068 3.903l113.682-169.367c2.469-4.001-.409-9.158-5.11-9.158h-41.388l36.145-107.16c1.313-3.892-1.582-7.924-5.69-7.924z" fill={c} fillOpacity=".75"/><path d="m63 254h-11c-3.48 0-5.45 3.99-3.33 6.75l32.38 42.29c1.7 2.22 5.04 2.2 6.71-.05l31.33-42.29c2.05-2.77.08-6.7-3.38-6.7h-11" stroke={c} strokeWidth="14" fill="none" strokeLinecap="round"/><path d="m449 254h11c3.48 0 5.45 3.99 3.33 6.75l-32.38 42.29c-1.7 2.22-5.04 2.2-6.71-.05l-31.33-42.29c-2.05-2.77-.08-6.7 3.38-6.7h11" stroke={c} strokeWidth="14" fill="none" strokeLinecap="round"/></svg>,
  "Participation Base Pay": ({c,bg,s=36})=><svg width={s} height={s} viewBox="0 0 420 462" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="280" width="58" height="180" rx="3" fill={bg} stroke={c} strokeWidth="7"/><rect x="88" y="220" width="58" height="240" rx="3" fill={c} fillOpacity=".3" stroke={c} strokeWidth="7"/><rect x="172" y="160" width="58" height="300" rx="3" fill={c} fillOpacity=".5" stroke={c} strokeWidth="7"/><rect x="256" y="100" width="58" height="360" rx="3" fill={c} fillOpacity=".7" stroke={c} strokeWidth="7"/><rect x="340" y="50" width="58" height="410" rx="3" fill={c} stroke={c} strokeWidth="7"/><path d="m6 50 l66-32 l84 44 l84-55 l84 40 l66-30" stroke="#F59E0B" strokeWidth="9" strokeLinecap="round" strokeLinejoin="round" fill="none"/></svg>,
  "Best Table Discussion": ({c,bg,s=36})=><svg width={s} height={s} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m223.685 324.372h64.658c21.091 6.321 39.375 18.68 39.375 32.91v84.444h-143.407v-84.444c0-14.23 18.255-26.589 39.374-32.91z" fill={bg}/><path d="m94.281 437.843h38.212l31.238-4.365 30.983 4.365h122.601l30.472-5.982 31.72 5.982h38.24v32h-323.466z" fill={c} fillOpacity=".25"/><path d="m7.512 361.25v124.441c0 12.224-10.002 22.226-22.226 22.226" fill="none"/><path d="m35.349 333.414h45.979c7.143-.68 14.457 2.239 19.105 8.362l37.419 49.55c1.87 2.494 3.911 3.798 7.653 3.798h46.856c11.764 0 21.317 9.553 21.317 21.317 0 11.792-9.554 21.316-21.317 21.316h-62.221c-6.436 0-12.813-2.948-16.98-8.476l-6.35-8.391" fill={c} fillOpacity=".2" stroke={c} strokeWidth="10" strokeLinecap="round"/><path d="m476.653 333.414h-45.951c-7.144-.68-14.457 2.239-19.105 8.362l-37.391 49.55c-1.728 2.268-3.741 3.798-7.653 3.798h-46.856c-11.792 0-21.345 9.553-21.345 21.317 0 11.792 9.553 21.316 21.345 21.316h62.192c6.463 0 12.814-2.948 17.009-8.476l6.321-8.391" fill={c} fillOpacity=".4" stroke={c} strokeWidth="10" strokeLinecap="round"/></svg>,
  "Speed Hands Award": ({c,bg,s=36})=><svg width={s} height={s} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m103.567 334.718h-76.553v-19.169c-.001-7.673-2.506-15.154-7.215-21.212-7.578-9.75-12.09-22.002-12.09-35.307v-102.171c0-7.951 6.445-14.396 14.396-14.396s14.396 6.445 14.396 14.396v45.298c0-7.951 6.445-14.396 14.396-14.396s14.396 6.445 14.396 14.396c0-7.951 6.445-14.396 14.396-14.396s14.396 6.445 14.396 14.396c0-7.951 6.445-14.396 14.396-14.396s14.396 6.445 14.396 14.396v79.213l36-62.311c6.27-10.861 20.158-14.582 31.019-8.311z" fill={bg} stroke={c} strokeWidth="12"/><rect x="19" y="336.6" width="91" height="44" rx="2" fill={c} fillOpacity=".3"/><rect x="15" y="378.9" width="99" height="126" rx="1" fill={c} fillOpacity=".45"/><path d="m275.035 236.178h-76.553v-19.169c-.001-7.673-2.506-15.154-7.215-21.212-7.578-9.75-12.09-22.002-12.09-35.307v-102.17c0-7.951 6.445-14.396 14.396-14.396s14.396 6.445 14.396 14.396c0-7.951 6.445-14.396 14.396-14.396s14.396 6.445 14.396 14.396c0-7.951 6.445-14.396 14.396-14.396s14.396 6.445 14.396 14.396c0-7.951 6.445-14.396 14.396-14.396s14.396 6.445 14.396 14.396v79.213l36-62.311c6.27-10.861 20.158-14.582 31.019-8.311z" fill={c} fillOpacity=".2" stroke={c} strokeWidth="12"/><rect x="190" y="238" width="91" height="44" rx="2" fill={c} fillOpacity=".45"/><rect x="186" y="280" width="99" height="222" rx="1" fill={c} fillOpacity=".65"/></svg>,
  "Group Rep Reward": ({c,bg,s=36})=><svg width={s} height={s} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><circle cx="256" cy="104" r="72" fill={bg} stroke={c} strokeWidth="12"/><rect x="207" y="135" width="98" height="96" rx="4" fill={bg}/><path d="m371.167 232.293-67.07-24.389-48.097 24.048-48.097-24.048-67.07 24.389c-12.672 4.608-21.107 16.651-21.107 30.134v89.767h272.548v-89.767c0-13.484-8.435-25.526-21.107-30.134z" fill={c} fillOpacity=".2"/><rect x="119" y="344" width="354" height="32" rx="8" fill={c} fillOpacity=".35"/><path d="m175.839 368.226v122.116c0 6.231 6.797 10.08 12.14 6.874l68.021-40.813 68.021 40.812c5.343 3.206 12.14-.643 12.14-6.874v-98.068z" fill={c} fillOpacity=".55"/><circle cx="390" cy="90" r="32" fill="#F59E0B" fillOpacity=".35" stroke="#F59E0B" strokeWidth="9"/><line x1="390" y1="75" x2="390" y2="90" stroke="#F59E0B" strokeWidth="6" strokeLinecap="round"/><circle cx="390" cy="98" r="3" fill="#F59E0B"/></svg>,
  "Behaviour Tagging": ({c,bg,s=36})=><svg width={s} height={s} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m442 247.71v-91.71c0-16.57 13.43-30 30-30s30 13.43 30 30v135.84c0 45.45-25.68 87-66.33 107.33l-53.67 26.83v60h-106v-130.55c0-25.37 19.22-46.62 44.46-49.15l67.87-29.06 22.46-22.45c8.383-8.383 20.606-10.841 31.21-7.08z" fill={bg}/><path d="m70 247.71c10.6-3.759 22.824-1.306 31.21 7.08l22.46 22.45 67.87 29.06c25.24 2.53 44.46 23.78 44.46 49.15v130.55h-106v-60l-53.67-26.83c-40.65-20.33-66.33-61.88-66.33-107.33v-135.84c0-16.57 13.43-30 30-30s30 13.43 30 30z" fill={c} fillOpacity=".2"/><path d="m318.95 26c54.78 0 73.87 50.45 73.87 80 0 60-49.32 94.09-136.82 170-87.5-75.91-136.82-110-136.82-170 0-29.55 19.09-80 73.87-80 33.63 0 52.27 24.55 62.95 44.09 10.68-19.54 29.32-44.09 62.95-44.09z" fill={c} fillOpacity=".45"/></svg>,
  "Rapid Fire Q&A": ({c,bg,s=36})=><svg width={s} height={s} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><rect x="215" y="8" width="82" height="258" rx="5" fill={bg}/><polygon points="224,276 254,276 254,487 224,487" fill={c} fillOpacity=".4"/><polygon points="105,487 70,487 220,276 254,276" fill={c} fillOpacity=".3"/><polygon points="374,487 409,487 259,276 224,276" fill={c} fillOpacity=".3"/><line x1="216" y1="124" x2="296" y2="124" stroke={c} strokeWidth="12" strokeLinecap="round"/><path d="m118 215h-35a5 5 0 0 0-5 5v16a5 5 0 0 0 5 5h35a13 13 0 1 0 0-26z" fill={c} fillOpacity=".5"/><path d="m103 163h-35a5 5 0 0 0-5 5v16a5 5 0 0 0 5 5h35a13 13 0 1 0 0-26z" fill={c} fillOpacity=".35"/><rect x="190" y="238" width="132" height="40" rx="10" fill={c} fillOpacity=".25"/></svg>,
  "Silent Skill Tracker": ({c,bg,s=36})=><svg width={s} height={s} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m118.161 14.95c-59.095 0-107 42.342-107 94.574s47.906 94.574 107 94.574c11.754 0 23.064-1.68 33.644-4.775l48.07 39.256-11.854-57.424c22.742-17.343 37.14-42.999 37.14-71.631 0-52.231-47.905-94.574-107-94.574z" fill={bg}/><path d="m165.879 77.818c11.374 11.373 11.374 29.985 0 41.358l-47.719 47.719-47.719-47.719c-11.373-11.374-11.373-29.985 0-41.358s29.985-11.374 41.358 0l6.36 6.36 6.36-6.36c11.373-11.374 29.985-11.374 41.358 0z" fill={c} fillOpacity=".65"/><path d="m222.544 497.098h-166.696c-12.225 0-22.226-10.002-22.226-22.226v-119.928c0-12.224 10.002-22.226 22.226-22.226h97.459l46.547-53.25v53.25h22.689c12.224 0 22.226 10.002 22.226 22.226v119.928c0 12.224-10.002 22.226-22.226 22.226z" fill={c} fillOpacity=".3"/><line x1="87" y1="400" x2="210" y2="400" stroke={c} strokeWidth="14" strokeLinecap="round"/><line x1="87" y1="432" x2="210" y2="432" stroke={c} strokeWidth="14" strokeLinecap="round"/><line x1="87" y1="464" x2="148" y2="464" stroke={c} strokeWidth="14" strokeLinecap="round"/><path d="m286.54 263.816c1.362 22.16-4.008 40.948-8.073 62.392-6.547 85.763 116.987 127.322 134.862 9.261 2.502-16.527 2.487-35.636 15.291-56.353 16.043-25.957 40.052-36.608 56.863-68.253 43.976-82.78-9.283-186.464-108.49-184.231-65.791 1.481-118.255 55.42-117.912 121.227 1.219 53.002 24.909 74.466 27.459 115.958z" fill={c} fillOpacity=".12"/></svg>,
};
  ...
  return (
    <div style={{position:"fixed",inset:0,zIndex:9000,background:"#FAFAFA",display:"flex",flexDirection:"column",overflowY:"auto"}}>
      ...
      <div style={{position:"relative",zIndex:1,textAlign:"center",padding:"40px 24px 28px",animation:"tpHeaderIn .6s cubic-bezier(0.22,1,0.36,1) .1s both"}}>
        ...
        <p style={{fontSize:15,color:"#6B7280",lineHeight:1.7,maxWidth:480,margin:"0 auto"}}>Each giving tool has creative uses beyond the obvious. Here's how experienced hosts use them to keep energy high all session long.</p>
      </div>
                ...
                return (
                  <div key={ti} className={`tp-card${isVisible?" visible":""}`} style={{background:"#fff",borderRadius:18,border:"1px solid rgba(0,0,0,0.07)",padding:"22px 22px 24px",boxShadow:"0 2px 12px rgba(0,0,0,0.06)",cursor:"default",position:"relative",overflow:"hidden"}}>
                    ...
                    <div style={{width:52,height:52,borderRadius:"50%",background:group.bg,border:`1.5px solid ${group.color}20`,display:"flex",alignItems:"center",justifyContent:"center",marginBottom:14,flexShrink:0}}>
                      {TipIcon ? <TipIcon c={group.color} bg={group.bg} s={32}/> : <group.Icon c={group.color} s={24}/>}
                    </div>
    ...
    <div className="tc-app-shell" style={{minHeight:"100vh",background:BG,fontFamily:"Poppins,sans-serif",display:"flex",flexDirection:"column"}}>
      ...
      <div className="tc-home-wrap" style={{flex:1,overflowY:"auto",display:"flex",flexDirection:"column"}}>
        ...
        <div className="tc-home-topnav" style={{display:"none",background:"#fff",borderBottom:`1px solid ${BORDER}`,padding:"0 32px",height:64,alignItems:"center",justifyContent:"space-between",flexShrink:0}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:10}}>
          <button onClick={()=>setShowTips(true)} title="Host Tips" className="tp-bulb-btn" style={{width:38,height:38,border:"none",background:"none",display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",flexShrink:0,padding:0}}><svg className="tp-bulb-icon" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#F59E0B" strokeWidth="2.2" strokeLinecap="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M12 2a7 7 0 0 1 7 7c0 2.5-1.5 4.7-3.5 6l-.5 3h-6l-.5-3C6.5 13.7 5 11.5 5 9a7 7 0 0 1 7-7z"/></svg></button>
        ...
        <div className="tc-home-inner">
          ...
          <div className="tc-home-left" style={{padding:"20px"}}>
            ...
            <div className="tc-home-mobile-topbar" style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:20}}>
              ...
              <div style={{display:"flex",alignItems:"center",gap:8}}>
              <button onClick={()=>setShowTips(true)} title="Host Tips" className="tp-bulb-btn" style={{width:36,height:36,border:"none",background:"none",display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",flexShrink:0,padding:0}}><svg className="tp-bulb-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#F59E0B" strokeWidth="2.2" strokeLinecap="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M12 2a7 7 0 0 1 7 7c0 2.5-1.5 4.7-3.5 6l-.5 3h-6l-.5-3C6.5 13.7 5 11.5 5 9a7 7 0 0 1 7-7z"/></svg></button>
              <button onClick={()=>setProfileOpen(v=>!v)}
