...
function TipsPage({ onClose }) {
  ...
  useEffect(() => {
    window.history.replaceState({}, "", "/app/tips");
    ...
    return () => { timers.forEach(clearTimeout); window.history.replaceState({}, "", "/app"); };
  }, []);
          ...
          <div key={group.tool} style={{marginBottom:36}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(280px,1fr))",gap:16}}>
              {group.tips.map((tip, ti) => {
                ...
                return (
                  <div key={ti} className={`tp-card${isVisible?" visible":""}`} style={{background:"#fff",borderRadius:18,border:"1px solid rgba(0,0,0,0.07)",padding:"22px 22px 24px",boxShadow:"0 2px 12px rgba(0,0,0,0.06)",cursor:"default",position:"relative",overflow:"hidden"}}>
                    ...
                    <div style={{position:"absolute",top:16,right:16,width:22,height:22,borderRadius:7,background:group.bg,border:`1px solid ${group.color}25`,display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"Plus Jakarta Sans,sans-serif",fontWeight:900,fontSize:10,color:group.color}}>{ti+1}</div>
                    <div style={{width:52,height:52,borderRadius:"50%",background:group.bg,border:`1.5px solid ${group.color}20`,display:"flex",alignItems:"center",justifyContent:"center",marginBottom:14,flexShrink:0}}>
                      {TipIcon ? <TipIcon s={32}/> : <group.Icon c={group.color} s={24}/>}
                    </div>
    ...
    <div className="tc-app-shell" style={{minHeight:"100vh",background:BG,fontFamily:"Poppins,sans-serif",display:"flex",flexDirection:"column"}}>
      ...
      <div className="tc-home-wrap" style={{flex:1,overflowY:"auto",display:"flex",flexDirection:"column"}}>
        ...
        <div className="tc-home-topnav" style={{display:"none",background:"#fff",borderBottom:`1px solid ${BORDER}`,padding:"0 32px",height:64,alignItems:"center",justifyContent:"space-between",flexShrink:0}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:10}}>
          <button onClick={()=>setShowTips(true)} title="Host Tips" className="tp-bulb-btn" style={{width:38,height:38,border:"none",background:"none",display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",flexShrink:0,padding:0}}><dotlottie-player src="https://lottie.host/60e7e27d-62da-4cea-8848-9f70d5ed4b66/3kpRZ5w0ze.lottie" autoplay loop style={{width:"40px",height:"40px",pointerEvents:"none"}}/></button>
        ...
        <div className="tc-home-inner">
          ...
          <div className="tc-home-left" style={{padding:"20px"}}>
            ...
            <div className="tc-home-mobile-topbar" style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:20}}>
              ...
              <div style={{display:"flex",alignItems:"center",gap:8}}>
              <button onClick={()=>setShowTips(true)} title="Host Tips" className="tp-bulb-btn" style={{width:36,height:36,border:"none",background:"none",display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",flexShrink:0,padding:0}}><dotlottie-player src="https://lottie.host/60e7e27d-62da-4cea-8848-9f70d5ed4b66/3kpRZ5w0ze.lottie" autoplay loop style={{width:"40px",height:"40px",pointerEvents:"none"}}/></button>
              <button onClick={()=>setProfileOpen(v=>!v)}
