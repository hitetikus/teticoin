...
const TOUR_STEPS = [
  {
    selector: '[data-tour="coin-buttons"]',
    title: "Award coins instantly",
    body: "Tap any coin amount to give points to the selected participant — live and instant.",
    placement: "top",
  },
  {
    selector: '[data-tour="qr-join"]',
    title: "Let participants join",
    body: "Share this QR code or link — participants join on their phone, no app needed.",
    placement: "bottom",
  },
  {
    selector: '[data-tour="quick-coins"]',
    title: "Quick Coins are your shortcuts",
    body: "These are preset award buttons. Customise them anytime via the ⋯ menu above.",
    placement: "top",
  },
];
...
function QuickTour({ onDone }) {
  ...
  const ttTopBase = placement === "top" ? sy - 148 : sy + sh + 12;
  const ttTop = ttTopBase < 12 ? sy + sh + 12 : ttTopBase;

  const arrowLeft = (sx + sw / 2) - ttLeft - 10;
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 9999, pointerEvents: "none" }}>
      ...
      <div style={{
        ...
        pointerEvents: "none",
        animation: "tcTourPulse 2s ease-in-out infinite",
      }} />
      ...
      <div key={step} style={{
        ...
        width: TOOLTIP_W,
        pointerEvents: "all",
        animation: "tcTourFade 0.22s ease",
        display: "flex",
        flexDirection: "column",
        gap: 0,
      }}>
        {/* Arrow — top of tooltip when placement=bottom */}
        {placement === "bottom" && (
          <div style={{ paddingLeft: Math.max(8, Math.min(arrowLeft, TOOLTIP_W - 28)), marginBottom: -1 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            fontWeight: 800, fontSize: 15, color: "#0A0A0F", marginBottom: 6,
          }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            ...
            <button
              ...
              style={{
                background: "linear-gradient(135deg,#FF4FB8,#9D50FF)",
                color: "#fff", border: "none", borderRadius: 999,
                padding: "9px 22px",
                fontFamily: "'DM Sans',sans-serif",
                fontWeight: 700, fontSize: 13, cursor: "pointer",
                boxShadow: "0 4px 14px rgba(255,79,184,0.35)",
              }}
            >
              {isLast ? "Done ✓" : "Got it →"}
            </button>
        ...
        {/* Arrow — bottom of tooltip when placement=top */}
        {placement === "top" && (
          <div style={{ paddingLeft: Math.max(8, Math.min(arrowLeft, TOOLTIP_W - 28)), marginTop: -1 }}>
      ...
      <button
        ...
        style={{
          ...
          fontFamily: "'DM Sans',sans-serif",
          fontSize: 12, cursor: "pointer", pointerEvents: "all",
