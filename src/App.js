...
function QRModal({ session, onClose }) {
  ...
  function downloadQR() {
    // Find the canvas or img generated by qrcodejs inside qrRef
    const container = qrRef.current;
    if (!container) return;
    const canvas = container.querySelector("canvas");
    const img = container.querySelector("img");
    if (canvas) {
      // Draw onto a larger canvas with white padding + label
      const pad = 24;
      const labelH = 48;
      ...
      link.download = `teticoin-qr-${session.code}.png`;
        ...
        <div style={{padding:"0 20px 32px"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr auto",gap:10}}>
            ...
            <button onClick={downloadQR} title="Download QR as PNG"
              style={{width:48,padding:"13px 0",background:BG,border:`1.5px solid ${BORDER}`,borderRadius:13,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
